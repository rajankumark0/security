...
@section('content')
                ...
                <div class="page-breadcrumb">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="page-breadcrumb-wrap">
                                ...
                                <div class="page-breadcrumb-info">                          
                                    ...
                                    <ul class="list-page-breadcrumb">
                                        <li class="active-page">Building Owner</li>
						 ...
						 <form type="post" class="" action="{{ url('/admin/building-owner/download') }}"  autocomplete="off">
 ...
 <a href="{{ url('/admin/building-owner/create') }}" style="float: right;margin-top: 9px;"><button class="btn btn-info"><i class="fa fa-plus-circle"></i> Add Building Owner</button></a>
   ...
   echo  $dat = date('d/m/y', $date); ?></td>
									...
									<a href="{{ url('/admin/building-owner/edit/'.$admin->id) }}" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                    <!-- <a href="{{ url('/admin/admin/view/'.$admin->id) }}" class="btn btn-success"><i class="fa fa-eye"></i></a> 
                                     <a onclick="return confirm('Are You Sure Want to delete')" href="{{ url('/admin/building-owner/delete/'.$admin->id) }}" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>-->
