                            ...
                            <div class="page-breadcrumb-wrap">
                                ...
                                <div class="page-breadcrumb-info">                                   
                                    ...
                                    <ul class="list-page-breadcrumb">
                                        ...
                                        <li class="active-page">Edit Building Owner</li>
                                    </ul>
...
<!-- Main Content -->
				...
				<div class="widget-container">
				 <div class="widget-block">
				  <form action="{{ url('/admin/building-owner/edit/'.$admin->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal" id="adminform" autocomplete="off">
							{{ csrf_field() }}
					   ...
					   <span class="text-danger error-email"></span> 
                        ...
                        <label>Building Owner Type</label>
							<select class="form-control" name="owner_type" >
								...
								<option @if($admin->owner_type=='Residential Block Owner') selected @endif value="Residential Block Owner">Residential Block Owner</option>
							</select>
						</div>
