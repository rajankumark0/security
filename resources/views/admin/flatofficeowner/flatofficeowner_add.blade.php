                            ...
                            <div class="page-breadcrumb-wrap">
                                ...
                                <div class="page-breadcrumb-info">                                   
                                    ...
                                    <ul class="list-page-breadcrumb">
                                        ...
                                        <li class="active-page">Add Tenant</li>
                                    </ul>
...
<!-- Main Content -->
				...
				<div class="widget-container">
				 <div class="widget-block">
				  <form action="{{ url('/admin/flat-office-owner/create') }}" method="post" enctype="multipart/form-data" class="form-horizontal" id="adminform" autocomplete="off">
							{{ csrf_field() }}
					   ...
					   <span class="text-danger error-email"></span> 
						 ...
						 <div class="form-group">
						   ...
						   @else
							   {{ "Flat No"}}
						   @endif</label>
					      <input type="text" class="form-control" name="floor_no" id="floor_no" value="{{ old('floor_no')}}" placeholder=" @endphp
						   @if($auth->owner_type=="Office Block Owner")
						   {{ "Office No"}}
						   @else
							   {{ "Flat No"}}
