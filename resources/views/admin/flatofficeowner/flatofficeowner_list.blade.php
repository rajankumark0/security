                            ...
                            <div class="page-breadcrumb-wrap">
                                ...
                                <div class="page-breadcrumb-info">
                                    ...
                                    <ul class="list-page-breadcrumb">
                                        ...
                                        <li class="active-page">Tenant Owner</li>
...
<div class="col-md-7" style="margin-top:15px;"> 
						 <form type="post" class="" enctype="multipart/form-data" action="{{ url('/admin/flat-office-owner/download') }}"  autocomplete="off" >
                        ...
                        <div class="col-md-2">
 <a href="{{ url('/admin/flat-office-owner/create') }}" style="float: right;margin-top: 9px;"><button class="btn btn-info"><i class="fa fa-plus-circle"></i>Add Tenant</button></a>
					    ...
					    @if(count($adminlist)>0)
                         <table class="table table-bordered">
                                ...
                                <tr>
									...
									<td id="mobile{{$admin->floor_no}}">{{$admin->floor_no}}</td>
									<td id="mobile{{$admin->id}}">{{$admin->mobile}}</td>
									
									<td id="country{{$admin->id}}"><?php  $date = strtotime($admin->created_at);
   echo  $dat = date('d/m/y', $date); ?></td>
									...
									<a href="{{ url('/admin/flat-office-owner/edit/'.$admin->id) }}" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                    <!-- <a href="{{ url('/admin/admin/view/'.$admin->id) }}" class="btn btn-success"><i class="fa fa-eye"></i></a> 
                                     <a onclick="return confirm('Are You Sure Want to delete')" href="{{ url('/admin/flat-office-owner/delete/'.$admin->id) }}" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>-->
