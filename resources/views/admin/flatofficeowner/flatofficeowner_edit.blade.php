                            ...
                            <div class="page-breadcrumb-wrap">
                                ...
                                <div class="page-breadcrumb-info">                                   
                                    ...
                                    <ul class="list-page-breadcrumb">
                                        ...
                                        <li class="active-page">Edit Tenant</li>
                                    </ul>
...
<!-- Main Content -->
				...
				<div class="widget-container">
				 <div class="widget-block">
				  <form action="{{ url('/admin/flat-office-owner/edit/'.$admin->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal" id="adminform" autocomplete="off">
							{{ csrf_field() }}
					  ...
					  <div class="form-group">
					   ...
					   <span class="text-danger error-email"></span> 
						 ...
						 <div class="form-group">
						   ...
						   @endphp
						   @if($auth->owner_type=="Office Block Owner")
						   {{ "Office No"}}
						   @else
							   {{ "Flat No"}}
						   @endif
						   </label>
					      <input type="text" class="form-control" name="floor_no" id="floor_no" value="{{ $admin->floor_no}}" placeholder="@endphp
						   @if($auth->owner_type=="Office Block Owner")
						   {{ "Office No"}}
						   @else
							   {{ "Flat No"}}
					 ...
					 <div class="form-group">
						...
						<div class="col-lg-3 col-md-4 mt-3 w_50">
							<div class="form-group">
								<button type="button" onclick="location.href = '{{ url('/admin/flat-office-owner') }}';" class="btn btn-block">Cancel</button>
							</div>
						</div>
