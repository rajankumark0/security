...
<!-- Main Content -->
				...
				<div class="widget-container">
				 <div class="widget-block">
				  <form action="{{ url('/admin/complaint/create') }}" method="post" enctype="multipart/form-data" class="form-horizontal" id="adminform" autocomplete="off">
							{{ csrf_field() }}
						<!--<div class="col-lg-12">	
					...
					<div class="col-lg-12">
						<div class="form-group">
							<label>Subject</label>
							<input type="text" name="subject" id="subject" value="{{ old('subject')}}" class="form-control"  required="required">
						</div>
					</div>
					...
					<div class="col-lg-12">
						<div class="form-group">
							...
							<input type="text" name="complaint" id="complaint" value="{{ old('complaint')}}" class="form-control"  required="required">
						</div>
					</div>
