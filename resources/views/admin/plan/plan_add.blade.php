...
<!-- Main Content -->
				...
				<div class="widget-container">
				 <div class="widget-block">
				  <form action="{{ url('/admin/plan/create') }}" method="post" enctype="multipart/form-data" class="form-horizontal" id="adminform" autocomplete="off">
							{{ csrf_field() }}
						<div class="col-lg-12">	
						  <div class="form-group">
							 <label>Plan Name</label>
						   <input type="text" name="plan_name" id="plan_name" value="{{ old('plan_name')}}" class="form-control"  required="required">
						  </div>			 
					    </div>
					...
					<div class="col-lg-12">
							<div class="form-group">
							 <label>Number Of Guard</label>
								 <input type="number" class="form-control" value="{{ old('gaurd') }}"  rows="5" id="gaurd"  name="gaurd">
					      </div>
					</div>	
