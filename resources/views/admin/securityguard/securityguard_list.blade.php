...
@section('content')
                ...
                <div class="page-breadcrumb">
                    ...
                    <div class="row">
                            ...
                            <div class="page-breadcrumb-wrap">
                                ...
                                <div class="page-breadcrumb-info">                                    
                                    ...
                                    <ul class="list-page-breadcrumb">
                                        <li class="active-page">Security Guard</li>
						...
						<div class="col-md-7" style="margin-top:15px;"> 
						 <form type="post" class="" enctype="multipart/form-data" action="{{ url('/admin/security-guard/download') }}"  autocomplete="off" >
                        ...
                        <div class="col-md-3">
                              <a href="{{ url('/admin/security-guard/create') }}" style="float: right;margin-top: 9px;"><button class="btn btn-info"><i class="fa fa-plus-circle"></i> Add Security Guard</button></a>
   ...
   echo  $dat = date('d/m/Y', $date); ?></td>
									...
									<a href="{{ url('/admin/security-guard/edit/'.$admin->id) }}" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                    <!-- <a href="{{ url('/admin/admin/view/'.$admin->id) }}" class="btn btn-success"><i class="fa fa-eye"></i></a>
                                     <a onclick="return confirm('Are You Sure Want to delete')" href="{{ url('/admin/security-guard/delete/'.$admin->id) }}" class="btn btn-danger"><i class="fa fa-trash-o"></i></a> -->
