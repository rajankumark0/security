                ...
                <div class="page-breadcrumb">
                    ...
                    <div class="row">
                            ...
                            <div class="page-breadcrumb-wrap">
                                ...
                                <div class="page-breadcrumb-info">                                   
                                    ...
                                    <ul class="list-page-breadcrumb">
                                        ...
                                        <li class="active-page">Sales Person</li>
						...
						<div class="col-md-7" style="margin-top:15px;"> 
						 <form type="post" class="" enctype="multipart/form-data" action="{{ url('/admin/sales-person/download') }}"  autocomplete="off" >
                        ...
                        <div class="col-md-2">
<a href="{{ url('/admin/sales-person/create') }}" style="float: right;margin-top: 9px;"><button class="btn btn-info"><i class="fa fa-plus-circle"></i>Add Sales Person</button></a>
   ...
   echo  $dat = date('d/m/y', $date); ?></td>
									...
									<a href="{{ url('/admin/sales-person/edit/'.$admin->id) }}" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                                    <!-- <a href="{{ url('/admin/admin/view/'.$admin->id) }}" class="btn btn-success"><i class="fa fa-eye"></i></a> 
                                     <a onclick="return confirm('Are You Sure Want to delete')" href="{{ url('/admin/sales-person/delete/'.$admin->id) }}" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>-->
