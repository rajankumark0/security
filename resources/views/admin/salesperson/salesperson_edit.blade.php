                            ...
                            <div class="page-breadcrumb-wrap">
                                ...
                                <div class="page-breadcrumb-info">                                   
                                    ...
                                    <ul class="list-page-breadcrumb">
                                        ...
                                        <li class="active-page">Edit Sales Person</li>
                                    </ul>
...
<!-- Main Content -->
				...
				<div class="widget-container">
				 <div class="widget-block">
				  <form action="{{ url('/admin/sales-person/edit/'.$admin->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal" id="adminform" autocomplete="off">
							{{ csrf_field() }}
					 ...
					 <div class="form-group">
						...
						<div class="col-lg-3 col-md-4 mt-3 w_50">
							<div class="form-group">
								<button type="button" onclick="location.href = '{{ url('/admin/sales-person') }}';" class="btn btn-block">Cancel</button>
							</div>
						</div>
