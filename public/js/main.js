(function($) {
    ...
    $(window).on('load', function() {
        ...
        owl.owlCarousel({
            ...
            itemsTablet: [600, 1],
            itemsMobile: [479, 1]
        });								var owl1 = $("#latest-property1");        owl1.owlCarousel({            navigation: false,            pagination: true,            slideSpeed: 1000,            stopOnHover: true,            autoPlay: true,            items: 1,            itemsDesktopSmall: [1024, 1],            itemsTablet: [600, 1],            itemsMobile: [479, 1]        });								
