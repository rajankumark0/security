		...
		<div class="container">
			<div class="row">
				...
				<div class="col-6 des-none">
					<div class="login-link mob-block">
					@if (Auth::user())
				...
				<div class="col-lg-3 col-md-4 col-sm-3 pl-md-0 login-bntbox">
					<div class="login-link mob-none">
        ...
        $.ajax({
				...
				success: function(response) {
				  ...
				  }else
				  {
					   ...
					   jQuery('.print-success-msg').html('<span style="color:green">Account successfully created. please login here</span>');
